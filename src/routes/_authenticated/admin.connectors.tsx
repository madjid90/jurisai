...
const CONNECTORS = [
  ...
  },
  {
    ...
    name: "Modèles de courriers",
    description: "Lettres RH depuis SocialGouv/cdtn-admin (GitHub, public)",
    auth: false,
    defaultPayload: {},
    badge: "Sans auth",
  },
  ...
  {
    id: "legifrance" as const,
    name: "Légifrance (legacy)",
    description: "Ancien connecteur. Utiliser LEGIFRANCE-FULL.",
    auth: true,
  ...
  {
    id: "judilibre" as const,
    name: "Judilibre (legacy)",
    description: "Ancien — utiliser JUDILIBRE-FULL.",
    auth: true,
  ...
  {
    id: "cdtn-modeles" as const,
    name: "CDTN — Modèles (legacy)",
    description: "Ancien — utiliser CDTN-MODELES-FULL.",
    auth: false,
    defaultPayload: {},
    badge: "Legacy",
  },
  ...
  },
  {
    ...
    name: "CDTN — Q/R (legacy)",
    description: "Ancien — utiliser CDTN-CONTRIBUTIONS-FULL.",
    auth: false,
  ...
  },
  {
    id: "cnil" as const,
    name: "CNIL (legacy)",
    description: "Ancien — utiliser CNIL-FULL.",
    auth: false,
  ...
  },
  {
    id: "dole" as const,
    name: "DOLE (legacy)",
    description: "Ancien — utiliser DOLE-FULL.",
    auth: true,
